...
export function AppUpdateButton() {
  ...
  return (
    <button
      ...
      className="interface-density-control flex h-7 shrink-0 items-center justify-center rounded-md bg-accent px-2.5 text-xs font-medium text-accent-foreground transition-colors hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-60"
